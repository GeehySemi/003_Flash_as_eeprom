...
/** 
  ...
  * @retval FMC_STATUS_T
  */
FMC_STATE_T flash_ee_page_erase(uint32_t page_address)
{
  uint16_t i;
  uint32_t erase_address;
  FMC_STATE_T flash_status;
  ...
  for(i = 0; i < EE_SECTOR_NUM; i++)
  {
    ...
    /* erase sector */ 
    if ((flash_status = FMC_ErasePage(erase_address)) != FMC_STATE_COMPLETE)
    {
      return flash_status;
    }
  }
...
/** 
  ...
  * @retval flash_status.
  */
FMC_STATE_T flash_ee_write_no_check(uint16_t address, uint16_t data)
{
  uint16_t valid_page;
  uint32_t find_address; 
  uint32_t end_address;
  FMC_STATE_T flash_status = FMC_STATE_COMPLETE;
  ...
  while (find_address < end_address)
  {
    ...
    {
      /* write data to flash */ 
      if ((flash_status = FMC_ProgramHalfWord(find_address, data)) != FMC_STATE_COMPLETE)
      {
        return flash_status;
      }
      
      /* write variable address to flash */
      if ((flash_status = FMC_ProgramHalfWord(find_address + 2, address)) != FMC_STATE_COMPLETE)
      {
        return flash_status;
      }
...
/** 
  ...
  * @retval flash_status
  */
FMC_STATE_T flash_ee_copy_to_new_page(void)
{
  uint16_t data;
  ...
  if ((flash_status = FMC_ProgramHalfWord(empty_page_address, EE_PAGE_TRANSFER)) != FMC_STATE_COMPLETE)
  {
    return flash_status;
  }
  ...
  for (idx = 0; idx < EE_PARA_MAX_NUMBER; idx++)
  {
    ...
    if (flash_ee_data_read(idx, &data) == 0)
    {
      ...
      if ((flash_status = flash_ee_write_no_check(idx, data)) != FMC_STATE_COMPLETE)
      {
        return flash_status;
      }
    }
  ...
  /* erase old page */
  if ((flash_status = flash_ee_page_erase(full_page_address)) != FMC_STATE_COMPLETE)
  {
    return flash_status;
  }

  /* change the status of the empty page to VALID */ 
  if ((flash_status = FMC_ProgramHalfWord(empty_page_address, EE_PAGE_VALID)) != FMC_STATE_COMPLETE)
  {
    return flash_status;
  }
...
/** 
  ...
  * @retval flash_status
  */
FMC_STATE_T flash_ee_format(void)
{
  FMC_STATE_T flash_status = FMC_STATE_COMPLETE;

  /* erase page 0 */
  if ((flash_status = flash_ee_page_erase(EE_PAGE0_ADDRESS)) != FMC_STATE_COMPLETE)
  {
    return flash_status;
  }

  /* erase page 1 */
  if ((flash_status = flash_ee_page_erase(EE_PAGE1_ADDRESS)) != FMC_STATE_COMPLETE)
  {
    return flash_status;
  }
...
/** 
  ...
  * @retval flash_status
  */
FMC_STATE_T flash_ee_full_check(void)
{
  uint16_t valid_page;
  uint32_t end_address;
  FMC_STATE_T flash_status = FMC_STATE_COMPLETE;
  ...
  if ((*(__IO uint32_t*)(end_address - 2)) != 0xFFFFFFFF)
  {
    ...
    if ((flash_status = flash_ee_copy_to_new_page()) != FMC_STATE_COMPLETE)
    {
      return flash_status;
    }
  }
...
/** 
  ...
  *         - 1: the format is incorrect
  */
FMC_STATE_T flash_ee_erase_transfer(uint16_t page0_status, uint16_t page1_status)
{
  if (page0_status == EE_PAGE_TRANSFER)
  {
    /* mark the status of page 0 as VALID */
...
/** 
  ...
  *         - 1: the format is incorrect
  */
FMC_STATE_T flash_ee_valid_transfer(uint16_t page0_status, uint16_t page1_status)
{                                  
  ...
  if ((flash_status = flash_ee_page_erase(erase_page_address)) != FMC_STATE_COMPLETE)
  {
    return flash_status;
  }
...
FMC_STATE_T flash_ee_init(void)
{
  ...
  if (flash_ee_format_check(page0_status, page1_status) != 0)
  {
    ...
    if ((flash_status = flash_ee_format()) != FMC_STATE_COMPLETE)
    {
      /* flash lock */
      FMC_Lock();
  ...
  {
    if ((flash_status = flash_ee_erase_transfer(page0_status, page1_status)) != FMC_STATE_COMPLETE)
    {
      /* flash lock */
      FMC_Lock();
  ...
  {
    if ((flash_status = flash_ee_valid_transfer(page0_status, page1_status)) != FMC_STATE_COMPLETE)
    {
      /* flash lock */
      FMC_Lock();
  ...
  if ((flash_status = flash_ee_full_check()) != FMC_STATE_COMPLETE)
  {
    /* flash lock */
    FMC_Lock();
...
/** 
  ...
  * @retval flash_status.
  */
FMC_STATE_T flash_ee_data_write(uint16_t address, uint16_t data)
{
  FMC_STATE_T flash_status = FMC_STATE_COMPLETE;
  ...
  if ((flash_status = flash_ee_full_check()) != FMC_STATE_COMPLETE)
  {
   ...
   /* write data to flash */ 
  if ((flash_status = flash_ee_write_no_check(address, data)) != FMC_STATE_COMPLETE)
  {
    /* flash lock */
    FMC_Lock();
