...
#define EE_SECTOR_SIZE           ((uint32_t)(1024 * 1))                        /*!< sector size */	

/*!< user do not need to care */ 
#define EE_FLASH_SIZE            ((*(uint16_t *)0x000203E0) & 0xFFFF)	         /*!< APM32 flash size information */ 

#define EE_PAGE_SIZE             ((uint32_t)(EE_SECTOR_NUM * EE_SECTOR_SIZE))  /*!< page size */

#define EE_BASE_ADDRESS          ((uint32_t)(0x00000000 + 1024 * EE_FLASH_SIZE - EE_PAGE_SIZE * 2)) /*!< eeprom base address */    
